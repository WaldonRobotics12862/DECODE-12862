...
@Autonomous(name="Red Audience Auton 9", preselectTeleOp = "WaldonTeleOp")
@Config
public class RedAudienceAuto_9 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Pose2d launchPose2 = new Pose2d(58,18,Math.toRadians(159));// for some reason, it needs to be corrected by 6 inches in the y-direction
        ...
        Action park = drive.actionBuilder(launchPose)
                .splineTo(new Vector2d(58, 38), Math.toRadians(90)) //was 36
                .build();
